...
(space-keys
  ...
  "cx" '((lambda() (interactive) (find-file "~/dotfiles/.xmonad/xmonad.hs")) :which-key "XMonad config")
  "cb" '((lambda() (interactive) (find-file "~/dotfiles/.config/xmobar/xmobarrc")) :which-key "XMobar config")
