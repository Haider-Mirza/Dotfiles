...
#+PROPERTY: header-args:elisp :tangle /home/haider/dotfiles/stow/.emacs.d/desktop.el
#+PROPERTY: header-args:conf :tangle /home/haider/dotfiles/stow/.config/polybar/config
#+AUTHOR: Haider Mirza
...
#+END_SRC
** Functions
Some of my EXWM focused Functions.
*** Launch Applications
#+BEGIN_SRC elisp
  (defun exwm/run-qute ()
    (interactive)
