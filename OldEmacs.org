...
Disabled this as I don't need it.
#+BEGIN_SRC elisp
...
#+END_SRC
*** Keybinds
Already have more keybinds for this
#+BEGIN_SRC elisp
  ;; (rune/leader-keys
...
#+begin_src elisp
  ...
  (rune/leader-keys
    ...
    "ce" '((lambda() (interactive) (find-file "~/repos/Dotfiles/Emacs.org")) :which-key "Emacs config")
    "cd" '((lambda() (interactive) (find-file "~/repos/Dotfiles/Desktop.org")) :which-key "Desktop config")
    "cs" '((lambda() (interactive) (find-file "~/repos/Dotfiles/System.org")) :which-key "System config")
    "cp" '((lambda() (interactive) (find-file "~/repos/Dotfiles/Programs.org")) :which-key "Programs config"))
